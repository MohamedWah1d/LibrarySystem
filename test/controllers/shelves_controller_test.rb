...
class ShelvesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shelf" do
    assert_difference("Shelf.count") do
      post shelves_url, params: { shelf: { max_capacity: @shelf.max_capacity, name: @shelf.name } }, as: :json
    end
  ...
  test "should update shelf" do
    patch shelf_url(@shelf), params: { shelf: { max_capacity: @shelf.max_capacity, name: @shelf.name } }, as: :json
    assert_response :success
  end
